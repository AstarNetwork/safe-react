...
module.exports = (config) => {
  ...
  config = appendWebpackPlugin(
    new FaviconsWebpackPlugin({
      ...
      logo: `${__dirname}/../../public/resources/logo.png`,
      ...
      favicons: {
        appName: 'Astar Safe',
        appShortName: 'Astar Safe',
        appDescription: 'Astar Safe is the most trusted platform to manage digital assets on Astar Network',
